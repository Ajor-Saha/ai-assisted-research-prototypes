        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-foreground">AI Text Explainer</h1>
                <p className="text-xs text-muted-foreground">Your step-by-step learning assistant</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="border-t border-border/40 bg-background/95 backdrop-blur">
        <div className="container mx-auto px-4 py-3">
          <p className="text-xs text-center text-muted-foreground">
            HCI Research Prototype • AI-Powered Educational Tool • Step-by-Step Visual Learning
          </p>
        </div>
      </div>
    </div>

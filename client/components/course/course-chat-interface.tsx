...
import { Send, Bot, User, Loader2, MessageSquarePlus, FileText } from "lucide-react"
        ...
        {currentChat ? (
                              ...
                              <ReactMarkdown
                                ...
                                components={{
                                  ...
                                  li: ({ children, className }) => {
                                    ...
                                    return (
                                      <li className={`text-sm text-gray-700 dark:text-gray-300 leading-relaxed ${isTaskList ? 'list-none flex items-start gap-2' : 'ml-4 marker:text-gray-500 dark:marker:text-gray-400'}`}>
                                        {children}
                                      </li>
                                    );
                                  },
                          ...
                          <Card className="p-3 bg-background/50">
                            <div className="flex items-start gap-2 mb-2">
                              ...
                              <div className="flex-1">
                                <p className="text-xs font-medium mb-2">Referenced Materials:</p>
                                <div className="space-y-1">
                                  {references.map((ref) => (
                                    <button
                                      key={ref.materialId}
                                      onClick={() => window.open(getMaterialViewUrl(ref.materialId), '_blank', 'noopener,noreferrer')}
                                      className="flex items-center gap-2 w-full text-left hover:bg-muted/50 rounded p-1 transition-colors cursor-pointer"
                                    >
            ...
            <div className="border-t p-4">
              <form onSubmit={handleSubmit} className="max-w-3xl mx-auto">
                <div className="flex gap-2">
                  ...
                  />
                  <Button type="submit" size="icon" disabled={isLoading || isStreaming || !input.trim()}>
          ...
          <div className="flex flex-col items-center justify-center h-full gap-4">
            ...
            <div className="text-center space-y-2">
              ...
              <p className="text-sm text-muted-foreground">Create a new chat to start a conversation</p>
            </div>
